...
export default function ModelPerformancePage() {
  ...
  useEffect(() => {
    fetch("/metrics.csv")
      ...
      .catch(() => setError("Unable to load model metrics."));
      ...
      <Card>
        <CardContent className="p-5">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            training loss during the first two epochs reflects rapid learning of dominant traffic patterns, followed
            by gradual convergence as the model captures finer spatio-temporal dynamics.
          </p>
        </CardContent>
      </Card>
    </div>
